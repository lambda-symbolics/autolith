...
(defun test-site-configuration-root ()
  ...
  (let* ((root
    ...
    (unwind-protect
         (progn
           (platform-setenv *platform* "AUTOLITH_SITE_CONFIG_ROOT"
           ...
           (let ((configuration
             ...
             (platform-unsetenv *platform* "AUTOLITH_SITE_CONFIG_ROOT")
             (let ((without-site
                     (configuration-create
                      :source-root source-root
                      :working-directory source-root
      ...
      (if previous-site-root
          (platform-setenv
           *platform* "AUTOLITH_SITE_CONFIG_ROOT" previous-site-root)
          (platform-unsetenv *platform* "AUTOLITH_SITE_CONFIG_ROOT"))
