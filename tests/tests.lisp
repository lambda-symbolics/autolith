...
(defun run-tests ()
  ...
  (test-nemo-relay-configuration)
  (test-nemo-relay-toml-dynamic-plugins)
  (test-nemo-relay-observability-boundary)
  (test-nemo-relay-dynamic-manifest-metadata)
  (test-nemo-relay-home-implicit-discovery)
  (test-nemo-relay-disabled-wrappers)
  (test-nemo-relay-unavailable-library)
  (test-nemo-relay-observability-bindings)
  (test-nemo-relay-observability-correctness)
  (test-nemo-relay-native-observability-lifecycle)
  (test-nemo-relay-tool-failure-metadata)
  (test-nemo-relay-native-lifecycle)
  (let ((configuration (configuration-create
    ...
    (test-localgroup-agent-session-identity)
