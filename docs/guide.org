...
An empty fullscreen session shows a centered Lisp-machine startup panel above the
composer. Once the session has transcript content, that content occupies the
viewport instead.
